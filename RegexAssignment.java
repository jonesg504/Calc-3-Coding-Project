...
public class RegexAssignment{
    ...
    public static boolean testPhoneNumber(String phoneNumber){
        return phoneNumber.matches("\\((678|404|770)\\)[0-9]{3}\\-[0-9]{4}");
    }
    ...
    public static boolean testName(String name){
        return name.matches("[A-Z][A-Za-z\\_]*(\\-[A-Z][A-Za-z\\_]*)?(\\'[A-Z][A-Za-z\\_]*)?\\s[A-Z][A-Za-z\\_]*(\\-[A-Z][A-Za-z\\_]*)?(\\'[A-Z][A-Za-z\\_]*)?");
    }
    ...
    public static boolean testAddress(String address){
    	return address.matches("[0-9]{1,5}\\s[A-Za-z0-9 \\.\\-]*\\n[A-Z][A-Za-z0-9 \\.\\-]*,?\\s[A-Z]{2}\\s[0-9]{5}([\\-0-9]{5})?");
    }
    ...
    public static boolean testJavaExecutable(String java){
        return java.matches("[^.]*public static void main\\(String\\[\\] [A-Za-z\\$\\_][A-Za-z0-9\\$\\_]*\\)[^.]*");
    }
}